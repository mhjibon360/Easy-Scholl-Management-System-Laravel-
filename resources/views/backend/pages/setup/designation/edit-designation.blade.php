...
@section('title', 'edit student designation list view')
@section('content')
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('setup.student.designation.view') }}">all</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" action="{{ route('setup.student.designation.update', $designation->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="name"
                                                value="{{ $designation->name }}" id="name">
                                            @error('name')
