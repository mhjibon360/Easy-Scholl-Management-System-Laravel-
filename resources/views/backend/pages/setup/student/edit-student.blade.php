...
@section('title', 'edit student class list view')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="card-title text-capitalize">Add Student class</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" action="{{ route('setup.student.class.update', $class->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3 form-group">
                                            <label for="name" class="form-label text-capitalize">class </label>
                                            <input class="form-control" type="text" name="name"
                                                value="{{ $class->name }}" id="name">
                                            @error('name')
