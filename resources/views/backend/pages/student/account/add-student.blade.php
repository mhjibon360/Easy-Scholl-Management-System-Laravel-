...
@section('title', 'create new student account')
@section('content')
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">crate new Student</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="card-title text-capitalize">Add New Student</h4>
                            <a href="{{ route('manage.user') }}" class=" btn btn-primary waves-effect waves-light">All User
                                List &nbsp;<i class=" fas fa-list"></i></a>
                        </div>
                        <div class="card-body">

                            <form id="myForm" action="{{ route('student.account.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input type="radio" id="ohters" name="gender" value="ohters">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3 form-group">
                                            <img src="" class=" img-fluid img-thumbnail p-1 photo_preview"
