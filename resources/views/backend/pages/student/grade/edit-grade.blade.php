...
@section('title', 'edit student grade')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="card-title text-capitalize">Edit Student grade</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" action="{{ route('student.student.grade.update',$grade->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="grade_point"
                                                value="{{ $grade->grade_point }}" id="grade_point">
                                            @error('grade_point')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="start_marks"
                                                value="{{ $grade->start_marks }}" id="start_marks">
                                            @error('start_marks')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="end_marks"
                                                value="{{ $grade->end_marks }}" id="end_marks">
                                            @error('end_marks')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="start_point"
                                                value="{{ $grade->start_point }}" id="start_point">
                                            @error('start_point')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="end_point"
                                                value="{{ $grade->end_point }}" id="end_point">
                                            @error('end_point')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="remarks"
                                                value="{{ $grade->remarks }}" id="remarks">
                                            @error('remarks')
                                                <span class=" text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
