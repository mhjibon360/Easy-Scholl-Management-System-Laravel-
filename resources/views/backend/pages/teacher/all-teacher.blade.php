...
@section('title', 'manage admin account')
@section('content')
            ...
            <div class="row ">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18 text-capitalize">Manage Teacher</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="card-title text-capitalize">Show All Teacher List</h4>
                            <a href="{{ route('add.user') }}" class=" btn btn-primary waves-effect waves-light">Add New
                                Teacher
