...
<body>
    ...
    <table>
        ...
        <tr>
            <th>Group</th>
            <td>{{ @$data->assignstudent->group->name }}</td>
        </tr>
        <tr>
            <th>Shift</th>
            <td>{{ @$data->assignstudent->shift->name }}</td>
        </tr>
        <tr>
            <th>Student ID</th>
            <td>{{ $data->id_no }}</td>
    ...
    <h3 class="section-title">Fee & Discount Details</h3>
    <table>
        <tr>
            <th>Fee Category</th>
            <td>Admission Fee</td>
        ...
        <tr>
            <th>Discount</th>
            <td>{{ $data->assignstudent->discount->discount }}%</td>
        </tr>
    </table>
    ...
    <div class="footer">
        <p>Generated on: {{ date('d F Y h:i A') }} | Easy Scholl Bangladesh</p>
    </div>
...
<body>
    ...
    <table>
        ...
        <tr>
            <th>Religion</th>
            <td style=" text-transform:capitalize;">{{ $data->religion }}</td>
        </tr>
        <tr>
            <th>Mobile</th>
            <td>{{ $data->mobile }}</td>
