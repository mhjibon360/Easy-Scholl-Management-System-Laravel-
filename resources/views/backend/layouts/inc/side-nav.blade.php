             ...
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         <li>
                             <a href="{{ route('manage.user') }}" data-key="t-login">User List</a>
                         </li>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         ...
                         <li>
                             <a href="{{ route('setup.student.group.view') }}" data-key="t-register">Student Group</a>
                         </li>
                         <li>
                             <a href="{{ route('setup.student.shift.view') }}" data-key="t-register">All Shift </a>
                         </li>
                         <li>
                             <a href="{{ route('setup.student.feecategory.view') }}" data-key="t-register">Fee Category
                             </a>
                         </li>
                         <li>
                             <a href="{{ route('setup.student.feeamount.view') }}" data-key="t-register">Fee Category
                                 Amount
                             </a>
                         </li>
                         <li>
                             <a href="{{ route('setup.student.examtype.view') }}" data-key="t-register">Student ExamType
                             </a>
                         </li>
                         <li>
                             <a href="{{ route('setup.student.subject.view') }}" data-key="t-register">Subjects List</a>
                         </li>
                         <li>
                         ...
                         <li>
                             <a href="{{ route('setup.student.designation.view') }}" data-key="t-register">Designation
                                 List</a>
                         </li>
                     </ul>
                 </li>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         ...
                         <li>
                             <a href="{{ route('student.registrationfe.generate') }}" data-key="t-login">Registration
                                 Fee</a>
                         </li>
