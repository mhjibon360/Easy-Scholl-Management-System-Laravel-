...
<!-- Mirrored from themesbrand.com/minia/layouts-lts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Sep 2025 03:39:51 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Login | Easy School</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="{{ url('/') }}" class="d-block auth-logo">
                                        <img src="{{ asset('backend') }}/assets/images/logo-sm.svg" alt=""
                                            height="28"> <span class="logo-txt">EASY SCHOOL</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Welcome Back !</h5>
                                        <p class="text-muted mt-2">Sign in to continue to EASY SCHOOL.</p>
                                    </div>
                                    ...
                                    <form class="mt-4 pt-2" action="{{ route('login') }}" method="POST" id="myForm">
                                        @csrf
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Don't have an account ? <a
                                                href="{{ url('/') }}" class="text-primary fw-semibold"> contact
                                                easy school
                                            </a> </p>
                                    </div>
                                </div>
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> EASY . Crafted with <i
                                            class="mdi mdi-heart text-danger"></i> by EASY SCHOOL
                                    </p>
                                </div>
                            </div>
                        </div>
